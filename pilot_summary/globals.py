...
FHIR_ENDPOINT = "http://gk-fhir-server-gatekeeper-%s.apps.okd.seclab.local/gk-fhir-server/fhir/%s?_summary=count"

OUTPUT_DIR_DEFAULT = './'
OUTPUT_FILENAME_DEFAULT = "%s-fhir-resources-summary-%s.csv"
...
FHIR_RESOURCES = [
  ...
  'NutritionOrder', 'Observation', 'ObservationDefinition', 'OperationDefinition', 'OperationOutcome', 'Organization',
